# Selected Book Items for Richard Amir Nasser

Evidence date: 2026-07-10

This file records the small, source-backed set of book/work items selected for public entity linking. It is intentionally limited. The goal is to support a clean author and protocol evidence trail, not to create Wikidata items for every KDP title at once.

## Entity Guardrails

- Use only the strongest public works first: DOI/research-backed works, print ISBNs, live Amazon pages, and works directly connected to established protocol or search-integrity entities.
- Do not mass-create entries for the full KDP catalog.
- Do not describe pending marks as registered trademarks.
